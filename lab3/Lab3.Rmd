...
rejected <- 0
par(mfrow=c(1,3))
datarDist <- rDist(2000, 2, 1.3, TRUE)
datarDist <- datarDist[datarDist < 100]
hist(datarDist, breaks = 20)
rejected1 <- rejected

rejected <- 0
datarDist <- rDist(2000, 5, 1.3, TRUE)
datarDist <- datarDist[datarDist < 100]
hist(datarDist, breaks = 20)
rejected2 <- rejected

rejected <- 0
datarDist <- rDist(2000, 8, 1.3, TRUE)
datarDist <- datarDist[datarDist < 100]
hist(datarDist, breaks = 20)
rejected3 <- rejected
