...
init <- c(0, 1)
test1 <- optim(init, minusLogLikelihood,  method = "CG")
test2 <- optim(init, minusLogLikelihood, gr = gradient,  method = "CG")
test3 <- optim(init, minusLogLikelihood, method = "BFGS")
test4 <- optim(init, minusLogLikelihood, gr = gradient, method = "BFGS")
